<template>
  <div class="flex justify-start my-2">
    <div class="my-auto">
      <div class="flex items-center justify-start p-0.5 cursor-pointer" @mouseenter="isHover = true" @mouseleave="isHover = false">
        <div
    ...
    <div class="overflow-hidden pl-2 w-full">
      ...
      <div class="text-xl font-semibold">
        ...
        >
          <Icon name="material-symbols:delete-outline" size="20"/>1
        </button>
        </div>
    </div>
  </div>
